...
export_welfare_tables <- function(welfare_results, baseline_equilibrium, database, output_dir = "results/welfare_tables") {
    ...
    baseline_tariffs <- database$tariffs
    baseline_trade_shares <- baseline_equilibrium$outcome_variables$bilateral_trade_shares
    baseline_expenditures <- baseline_equilibrium$outcome_variables$total_expenditures
