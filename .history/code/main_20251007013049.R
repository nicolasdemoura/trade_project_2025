...
###############################################################################
# TASK 3: MODEL CALIBRATION - Imobile Labor
###############################################################################

cat("\n=== TASK 3b: MODEL CALIBRATION - Imobile Labor ===\n")
...
gg_scatterplot(data = trade_shares_plot_data,
         ...
         y_label = "Predicted Trade Shares",
         out_dir = "figures",
         out_name = "trade_flows_fit_imobile",
         width = 9,
         height = 9,
         xlim = c(0,1),
         ylim = c(0,1),
...
saveRDS(list(
    ...
    equilibrium_solution = equilibrium_solution,
    welfare_analysis = welfare_analysis
), file = "output/cdk_model_results_imobile.rds")
