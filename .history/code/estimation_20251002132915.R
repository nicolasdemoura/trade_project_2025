...
#' @param tech_estimation Results from estimate_cdk_technology_params
...
calibrate_multisector_baseline <- function(tech_estimation, cleaned_data, tau_array = NULL, theta = NULL, labor_mobility = TRUE) {
