...
sector_groups <- list(
  "Food" = c("15t16", "AtB"),  # Food products + Agriculture
  "Textiles" = c("17t18", "19"),  # Textiles + Leather
  "Wood" = c("20"),  # Wood products
  "Paper" = c("21t22"),  # Paper products
  "Fuel" = c("23", "C"),  # Petroleum products + Mining
  "Chemicals" = c("24"),  # Chemicals
  "Plastic" = c("25"),  # Rubber and plastic
  "Minerals" = c("26"),  # Non-metallic minerals
  "Metals" = c("27t28"),  # Basic metals and fabricated metal
  "Machinery" = c("29"),  # Machinery
  "Electrical" = c("30t33"),  # Electrical equipment
  "Transport" = c("34t35", "60", "61", "62"),  # Transport equipment + Transport services
  "Misc.Manuf." = c("36t37"),  # Other manufacturing
  "Services" = c("50", "51", "52", "63", "64", "70", "71t74", "E", "F", "H", "J", "L", "M", "N", "O", "P")  # All services
)
