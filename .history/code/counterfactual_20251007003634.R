...
export_welfare_tables <- function(welfare_results, baseline_equilibrium, database, output_dir = "results/welfare_tables") {
    ...
    for (scenario_name in names(welfare_results)) {
        ...
        welfare_table <- data.frame(
            Baseline_Tariff = round(baseline_avg_tariffs * 100, 0),
            Counterfactual_Tariff = round(counterfactual_avg_tariffs * 100, 0),
            Welfare_Change_Pct = round(welfare_effects$welfare_change_pct, 0),
            Income_Change_Pct = round((welfare_effects$income_change / baseline_equilibrium$outcome_variables$real_income) * 100, 0),
            Tariff_Revenue_Change_Pct = round((welfare_effects$tariff_revenue_change / baseline_equilibrium$outcome_variables$real_tariff_revenue) * 100, 0),
