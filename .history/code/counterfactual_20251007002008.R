...
export_welfare_tables <- function(welfare_results, baseline_equilibrium, database, output_dir = "results/welfare_tables") {
    ...
    for (scenario_name in names(welfare_results)) {
        ...
        baseline_trade_shares <- baseline_equilibrium$outcome_variables$trade_shares
        ...
        baseline_expenditures <- baseline_equilibrium$outcome_variables$expenditures
        counterfactual_expenditures <- welfare_results[[scenario_name]]$counterfactual_outcomes$expenditures
        
        baseline_sector_shares <- baseline_expenditures[us_index, ] / sum(baseline_expenditures[us_index, ])
        counterfactual_sector_shares <- counterfactual_expenditures[us_index, ] / sum(counterfactual_expenditures[us_index, ])
