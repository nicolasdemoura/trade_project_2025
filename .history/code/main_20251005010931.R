...
if (equilibrium_solution$converged) {
    ...
    cat("  - Price indices P:", paste(dim(equilibrium_solution$prices), collapse = " x "), "\n")
    cat("  - Expenditures X:", paste(dim(equilibrium_solution$expenditures), collapse = " x "), "\n")
    cat("  - Income Y:", length(equilibrium_solution$total_income), "countries\n")
    cat("  - Wages w:", paste(dim(equilibrium_solution$wages), collapse = " x "), "\n")
    cat("  - Iceberg costs d:", paste(dim(equilibrium_solution$iceberg_costs), collapse = " x "), "\n")
} else {
...
scatter plot of observed vs predicted trade flows
