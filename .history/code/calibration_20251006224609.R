...
export_iceberg_tables <- function(equilibrium_solution, output_dir = "tables") {
  ...
  iceberg_costs <- equilibrium_solution$calibrated_parameters$iceberg_costs
  bilateral_costs <- equilibrium_solution$calibrated_parameters$bilateral_costs
  importer_effects <- equilibrium_solution$calibrated_parameters$importer_effects
  exporter_effects <- equilibrium_solution$calibrated_parameters$exporter_effects
  ...
  for(k in 1:dim(iceberg_costs)[3]) {
    ...
    print(iceberg_xtable,
          file = file.path(output_dir, paste0("iceberg_costs_", sector, ".tex")),
  ...
  print(bilateral_xtable,
        file = file.path(output_dir, "bilateral_costs.tex"),
        include.rownames = TRUE,
        caption.placement = "top",
        sanitize.text.function = identity,
        tabular.environment = "longtable",
  ...
  print(importer_xtable,
        file = file.path(output_dir, "importer_effects.tex"),
        include.rownames = TRUE,
        caption.placement = "top",
        sanitize.text.function = identity,
        tabular.environment = "longtable",
  ...
  print(exporter_xtable,
        file = file.path(output_dir, "exporter_effects.tex"),
        include.rownames = TRUE,
        caption.placement = "top",
        sanitize.text.function = identity,
        tabular.environment = "longtable",
