...
export_welfare_tables <- function(welfare_results, baseline_equilibrium, database, output_dir = "results/welfare_tables") {
    ...
    for (scenario_name in names(welfare_results)) {
        ...
        counterfactual_trade_shares <- welfare_results[[scenario_name]]$model_solution$trade_shares
        ...
        counterfactual_sector_shares <- welfare_results[[scenario_name]]$model_solution$sector_shares
