...
# Define sector groups - mapping from WIOD codes to 8 aggregated sectors
sector_groups <- list(
  "Agriculture" = c("AtB", "c1"),  # Agriculture, hunting, forestry and fishing
  "Manufacturing" = c("15t16", "c3", "17t18", "c4", "19", "c5", "20", "c6", "21t22", "c7", 
                     "24", "c9", "25", "c10", "26", "c11", "27t28", "c12", "29", "c13", 
                     "30t33", "c14", "34t35", "c15", "36t37", "c16"),  # All manufacturing
  "Mining" = c("C", "c2"),  # Mining and quarrying
  "Energy" = c("23", "c8", "E", "c17"),  # Petroleum, chemical, rubber, plastic products + Electricity, gas and water supply
  "Construction" = c("F", "c18"),  # Construction
  "Trade" = c("50", "c19", "51", "c20", "52", "c21", "H", "c22"),  # Trade and hotels
  "Transport" = c("60", "c23", "61", "c24", "62", "c25", "63", "c26", "64", "c27"),  # Transport and communications
  "Services" = c("J", "c28", "70", "c29", "71t74", "c30", "L", "c31", "M", "c32", 
                "N", "c33", "O", "c34", "P", "c35")  # Business and other services
)
