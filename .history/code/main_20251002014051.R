...
cleaned_data <- clean_all_data_cdk(wiot_file_path, socioeco_file_path, target_year)
...
# Get country names with NA data in at least one of tech composite 
countries_with_na_tech <- countries[apply(is.na(tech_estimation$technology_composite[,1:34]), 1, any)]
