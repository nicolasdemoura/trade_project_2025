...
tryCatch({
  ...
  socioeco_dict <- read_excel("code/data/Socio_Economic_Accounts_July14.xlsx", sheet = 1)
  socioeco_data <- read_excel("code/data/Socio_Economic_Accounts_July14.xlsx", sheet = "DATA")
...
tryCatch({
  ...
  if (exists("wiot_full")) {
    ...
    if (file.exists("code/data/Socio_Economic_Accounts_July14.xlsx")) {
      ...
      cleaned_data <- clean_all_data_cdk(wiot_2011_sample, "code/data/Socio_Economic_Accounts_July14.xlsx", 2011)
      ...
      cat("   Expected path: code/data/Socio_Economic_Accounts_July14.xlsx\n")
    }
