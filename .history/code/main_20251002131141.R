...
# Set labor_mobility = FALSE for immobile labor (sector-specific wages)
# Set labor_mobility = TRUE for mobile labor (wages equalize across sectors within countries)
baseline_results <- calibrate_multisector_baseline(cdk_estimation_results = tech_estimation$technology_composite, 
                                                   cleaned_data = cleaned_data,
                                                   labor_mobility = FALSE)  # Change to TRUE for mobile labor
