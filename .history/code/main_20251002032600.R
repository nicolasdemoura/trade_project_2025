...
target_year <- 2011  # Use 2011 as specified in the counterfactual analysis

# Define country groupings for aggregation  
...
# Define country groups - you can modify this list to group other countries
country_groups <- list(
  "EU" = EU_COUNTRIES
  # Add other groupings here if desired, e.g.:
  # "NAFTA" = c("USA", "CAN", "MEX"),
  # "ASEAN" = c("THA", "VNM", "SGP", "MYS", "IDN", "PHL")
)
