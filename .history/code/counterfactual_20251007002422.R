...
export_welfare_tables <- function(welfare_results, baseline_equilibrium, database, output_dir = "results/welfare_tables") {
    ...
    for (scenario_name in names(welfare_results)) {
        ...
        counterfactual_sector_shares <- welfare_results[[scenario_name]]$counterfactual_outcomes$sector_shares
        ...
        welfare_table <- data.frame(
            Country = welfare_effects$country,
            Baseline_Welfare = round(welfare_effects$baseline_welfare, 3),
            Counterfactual_Welfare = round(welfare_effects$counterfactual_welfare, 3),
            Welfare_Change = round(welfare_effects$welfare_change, 3),
            ...
            Tariff_Change = round((counterfactual_avg_tariffs - baseline_avg_tariffs) * 100, 2),
            stringsAsFactors = FALSE
        )
