...
print(alpha_xtable, file = "tables/alpha_table.tex", include.rownames = TRUE, caption.placement = "top", 
...
print(beta_xtable, file = "tables/beta_table.tex", include.rownames = TRUE, caption.placement = "top", 
    sanitize.text.function = identity,
    tabular.environment = "longtable",
    floating = FALSE)
...
print(T_xtable, file = "tables/technology_table.tex", include.rownames = TRUE, caption.placement = "top", 
    sanitize.text.function = identity,
    tabular.environment = "longtable",
    floating = FALSE)
...
for(i in 1:dim(processed_database$tariffs)[1]) {
    ...
    print(tariff_xtable, 
        file = paste0("tables/tariff_table_", country, ".tex"),
        include.rownames = TRUE, 
        caption.placement = "top", 
        sanitize.text.function = identity,
        tabular.environment = "longtable",
