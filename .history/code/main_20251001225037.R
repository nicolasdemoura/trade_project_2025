...
# Examine WIOD full data structure
print("WIOD Full Data Structure:")
print(paste("Dimensions:", paste(dim(wiot_full), collapse = " x ")))
print("Column names:")
print(colnames(wiot_full))
print("First few observations:")
print(head(wiot_full, 3))

# Examine Socio-Economic Accounts structure
print("\nSocio-Economic Accounts Structure:")
print(paste("Dimensions:", paste(dim(socioeco), collapse = " x ")))
print("Column names:")
