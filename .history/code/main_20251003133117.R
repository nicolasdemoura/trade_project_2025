...
# Define tariff data path (optional - set to NULL if no tariff data available)
tariff_file_path <- NULL  # e.g., "data/tariffs.csv" if you have tariff data

# Load and clean the data with country and sector aggregation 
cleaned_data <- clean_all_data_cdk(wiot_file_path, socioeco_file_path, exchange_rates_file_path, target_year, country_groups, sector_groups, tariff_file_path)
