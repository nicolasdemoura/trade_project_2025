...
map_sector <- function(x) {
  ...
  ifelse(!is.na(idx), clean_names[idx], NA)
}

# Example usage
map_sector("Textiles and Textile Products")  # returns "Textiles"
...
#' @param tau_array Trade costs (origin x destination x sectors)
