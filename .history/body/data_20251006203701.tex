...
\begin{equation}
\gamma_{ikk'} = \frac{X_{ikk'}}{\text{Gross Output}_{ik}}
\end{equation}

Final expenditure shares are derived as:
\begin{equation}
\alpha_{nk} = \frac{X_{nk}^{final}}{\sum_{k'} X_{nk'}^{final}}
\end{equation}

Trade shares are calculated as:
\begin{equation}
\pi_{nik} = \frac{X_{nik}}{\sum_{i'} X_{ni'k}}
\end{equation}
