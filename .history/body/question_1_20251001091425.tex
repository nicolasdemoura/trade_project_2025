...
\begin{solution}
    ...
    \begin{align*}
        ...
        &= f k \int_{\varphi^*}^{\infty} \frac{1}{\phi}\left( \left(\frac{\phi}{\varphi^*}\right)^{\sigma - 1} - 1 \right) \left(\frac{\varphi^*}{\varphi_{min}}\right)^k \left(\frac{\varphi_{min}}{\phi}\right)^k d\phi \\
    \end{align*}
