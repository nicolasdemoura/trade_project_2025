...
\end{equation}
This approach leverages the theoretical restriction that comparative advantage patterns in the model must match observed trade flows, providing robust identification of country-sector productivity levels. We also have some issues with multicollinearity in the regression, which we address by using matrix completion via low-rank matrix approximation with nuclear norm regularization Table \ref{tab:technology} presents the estimated productivity matrix.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{code/figures/trade_flows_fit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{code/figures/gdp_fit.png}
