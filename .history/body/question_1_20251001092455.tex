...
\begin{solution}
    ...
    \paragraph{Weighted Average Productivity.} The CES price index is given by:
    \begin{align*}
        P &= \left( \int_{\varphi^*}^{\infty} p(\varphi)^{1 - \sigma} d\mu(\varphi) \right)^{\frac{1}{1 - \sigma}} \\
        &= \left( \int_{\varphi^*}^{\infty} \left( \frac{1}{\sigma} r(\varphi) - f \right)^{1 - \sigma} d\mu(\varphi) \right)^{\frac{1}{1 - \sigma}} \\
        &= \left( \int_{\varphi^*}^{\infty} \left( \frac{1}{\sigma} \left(\frac{\varphi}{\varphi^*}\right)^{\sigma - 1} \sigma f - f \right)^{1 - \sigma} d\mu(\varphi) \right)^{\frac{1}{1 - \sigma}} \\
        &= \left( \int_{\varphi^*}^{\infty} \left( \frac{1}{\sigma} \left(\frac{\varphi}{\varphi^*}\right)^{\sigma - 1} \sigma f - f \right)^{1 - \sigma} d\mu(\varphi) \right)^{\frac{1}{1 - \sigma}} \\
    \end{align*}
