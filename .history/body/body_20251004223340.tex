...
\begin{align*}
   ...
   \sum_{k} \sum_{n} {\color{orange}\pi_{ink}} {\color{green}\alpha_{nk}} Y_n & \text{(Trade Balance - Mobile Labor)}  &=
   \sum_{k} {\color{orange}w_{ik}} {\color{orange}L_{ik}} + \sum_{k} \sum_{j} {\color{blue}\tau_{jik}} {\color{orange}\pi_{jik}} {\color{green}\alpha_{jk}} Y_j \\
