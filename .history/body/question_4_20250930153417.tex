...
\begin{itemize}
	...
	\item \emph{Reallocation intensifies:} Labor reallocates toward high-$\varphi$ firms that now scale up to serve the integrated market, magnifying the within-industry productivity gains.
	\item \emph{Pareto note:} With a Pareto productivity distribution and the truncated-moment property $\mathbb{E}[\varphi^{\sigma-1}|\varphi\ge a]=\tfrac{\theta}{\theta-(\sigma-1)}a^{\sigma-1}$, removing wedges (no $\tau^{1-\sigma}$ attenuation; no $f_x$) implies imported varieties enter at full weight in $P^{1-\sigma}$. Hence $P$ falls more than under positive trade costs, and real income $R/P$ rises more.
\end{itemize}
