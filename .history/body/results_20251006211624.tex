...
where:
\begin{align*}
\boldsymbol{\theta} = \begin{bmatrix} \{d_{ni}\}_{n \neq i, n=1,\ldots,N; i=1,\ldots,N} & \{d_{ik}^{\text{importer}}\}_{i=1,\ldots,N; k=1,\ldots,K} & \{d_{jk}^{\text{exporter}}\}_{j=1,\ldots,N; k=1,\ldots,K} & \{w_{ik}\}_{i=1,\ldots,N; k=1,\ldots,K} & \{p_{ik}\}_{i=1,\ldots,N; k=1,\ldots,K} \end{bmatrix}'
\end{align*}
