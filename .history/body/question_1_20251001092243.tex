...
\begin{solution}
    ...
    \begin{align*}
        \frac{1-G(\varphi^*)}{\delta} \bar{\pi} = f_e &\iff \frac{1 - \left( \frac{\varphi_{min}}{\varphi^*} \right)^k}{\delta} \frac{fk}{k + 1 - \sigma} = f_e \\
        &\iff \frac{\left( \frac{\varphi^*}{\varphi_{min}} \right)^k - 1}{\delta} \frac{fk}{k + 1 - \sigma} = f_e \\
        &\iff \left( \frac{\varphi^*}{\varphi_{min}} \right)^k = 1 + \frac{\delta f_e (k + 1 - \sigma)}{fk}
    \end{align*}
    Thus, the cutoff productivity is given by:
    \begin{align*}
        \varphi^* = \varphi_{min} \left( 1 + \frac{\delta f_e (k + 1 - \sigma)}{fk} \right)^{\frac{1}{k}}
    \end{align*}
