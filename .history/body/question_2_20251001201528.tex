...
\begin{solution}
	...
	\begin{align*}
		...
		&=  \int_{\varphi^*}^{\infty} \left(\frac{1}{\rho\varphi}\right)^{1-\sigma} M\frac{g(\varphi)}{1 - G(\varphi^*)} d\varphi + \chi N \int_{\varphi_x^*}^{\infty} \left(\frac{\tau}{\rho\varphi}\right)^{1-\sigma} \frac{g(\varphi)}{1 - G(\varphi_x^*)} d\varphi \\
		\end{align*}
	\end{solution}