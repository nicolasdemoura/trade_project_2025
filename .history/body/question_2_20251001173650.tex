...
\begin{solution}
	...
	\begin{align*}
		...
		&\iff \frac{1-G(\varphi^*)}{\delta} \left[ \int_{\varphi^*}^{\infty} \pi_d(\varphi) dG(\varphi) + \chi N \int_{\varphi_x^*}^{\infty} \pi_x(\varphi) dG(\varphi) \right] = f_e\\
		&\iff \frac{1-G(\varphi^*)}{\delta} \left[ \int_{\varphi^*}^{\infty} \left( f \left[ \left(\frac{\varphi}{\varphi^*}\right)^{\sigma - 1} - 1 \right] \right) dG(\varphi) + \chi N \int_{\varphi_x^*}^{\infty} \left( f_x \left[ \left(\frac{\varphi}{\varphi_x^*}\right)^{\sigma - 1} - 1 \right] \right) dG(\varphi) \right] = f_e 
	\end{align*}
\end{solution}