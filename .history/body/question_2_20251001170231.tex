...
\begin{solution}
	...
	\begin{align*}
		\pi_x(\varphi) &= r_x(\varphi) - \frac{\tau}{\varphi} q_x(\varphi) - f_x \\
		&= \tau^{1-\sigma} r(\varphi) - f_x - \frac{\tau}{\varphi}Q\left(\frac{p_x(\varphi)}{P}\right)^{-\sigma} \\
		&= \tau^{1-\sigma} r(\varphi) - f_x - \frac{\tau}{\varphi}Q\left(\frac{\tau}{\rho \varphi P}\right)^{-\sigma} \\
		&= \tau^{1-\sigma} r(\varphi) - f_x - \tau^{1-\sigma} \frac{1}{\sigma} r
		\end{align*}