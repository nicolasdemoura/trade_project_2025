...
\begin{solution}
	...
	\begin{align*}
		...
		&\quad + \frac{\chi N f_x}{\delta} \left[ \int_{\varphi_x^*}^{\infty} \left(\frac{\varphi}{\varphi_x^*}\right)^{\sigma - 1} \left(\frac{\varphi_{\min}}{\varphi}\right)^k d\varphi - \int_{\varphi_x^*}^{\infty} \left(\frac{\varphi_{\min}}{\varphi}\right)^k d\varphi \right] = f_e
	\end{align*}
\end{solution}