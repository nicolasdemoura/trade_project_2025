...
\begin{solution}
    ...
    \paragraph{Pareto Distribution.} Assume that the productivity distribution is Pareto with parameters $\underline{\varphi}$ and $k > \sigma - 1$:
    \begin{align*}
        G(\varphi) = 1 - \left( \frac{\underline{\varphi}}{\varphi} \right)^k, \quad g(\varphi) = k \frac{\underline{\varphi}^k}{\varphi^{k+1}}, \quad \text{for } \varphi \geq \underline{\varphi}
    \end{align*}
