...
\begin{solution}
    ...
    \begin{align*}
        ...
        &= fk (\varphi^*)^k \int_{\varphi^*}^{\infty} \left( \varphi^{\sigma - 1 - k - 1} - \varphi^{-k - 1} \right) d\varphi \\
        &= fk (\varphi^*)^k \left[ \frac{\varphi^{\sigma - k - 1}}{\sigma - k - 1} + \frac{\varphi^{-k}}{k} \right]_{\varphi^*}^{\infty} \\
        &= fk (\varphi^*)^k \left( 0 - \left[ \frac{(\varphi^*)^{\sigma - k - 1}}{\sigma - k - 1} + \frac{(\varphi^*)^{-k}}{k} \right] \right) \\
        &= fk (\varphi^*)^k \left( - \frac{(\varphi^*)^{\sigma - k - 1}}{\sigma - k - 1} - \frac{(\varphi^*)^{-k}}{k} \right) \\
        &= f \left( - \frac{k}{\sigma - k - 1} (\varphi^*)^{\sigma - 1} - 1 \right) \\
        &= f \left( \frac{k}{k + 1 - \sigma} (\varphi^*)^{\sigma - 1} - 1 \right)
    \end{align*}
