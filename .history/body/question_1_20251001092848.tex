...
\begin{solution}
    ...
    \end{align*}
    Substituting our expression for $\varphi^*$, we have:
    \begin{align*}
        \tilde{\varphi} &= \left( \frac{k}{k + 1 - \sigma} \right)^{\frac{1}{\sigma - 1}} \varphi_{min} \left(\frac{fk}{\delta f_e (k + 1 - \sigma)}\right)^{\frac{1}{k}} \\
        &= \varphi_{min} \left( \frac{k}{k + 1 - \sigma} \right)^{\frac{1}{\sigma - 1}} \left(\frac{fk}{\delta f_e (k + 1 - \sigma)}\right)^{\frac{1}{k}} \\
        &= \varphi_{min} \left( \frac{k}{k + 1 - \sigma} \right)^{\frac{1}{\sigma - 1} + \frac{1}{k}} \left(\frac{fk}{\delta f_e}\right)^{\frac{1}{k}} \\
        &= \varphi_{min} \left( \frac{k}{k + 1 - \sigma} \right)^{\frac{k + \sigma - 1}{k(\sigma - 1)}} \left(\frac{fk}{\delta f_e}\right)^{\frac{1}{k}}
    \end{align*}
    \end{solution}