...
& United Kingdom & GBR \\
\midrule
\multirow{7}{3cm}{\textbf{European Union}} & \multirow{7}{8cm}{Austria, Belgium, Bulgaria, Croatia, Cyprus, Czech Republic, Denmark, Estonia, Finland, France, Germany, Greece, Hungary, Ireland, Italy, Latvia, Lithuania, Luxembourg, Malta, Netherlands, Poland, Portugal, Romania, Slovakia, Slovenia, Spain, Sweden} & \multirow{7}{4cm}{AUT, BEL, BGR, HRV, CYP, CZE, DNK, EST, FIN, FRA, DEU, GRC, HUN, IRL, ITA, LVA, LTU, LUX, MLT, NLD, POL, PRT, ROU, SVK, SVN, ESP, SWE} \\
& & \\
& & \\
& & \\
& & \\
...
& & \\
\midrule
\multirow{2}{3cm}{\textbf{Rest of World}} & \multirow{2}{8cm}{Australia, Indonesia, Korea, Russia, Turkey, Taiwan, Other economies} & \multirow{2}{4cm}{AUS, IDN, KOR, RUS, TUR, TWN, RoW} \\
& & \\
\bottomrule
\end{tabular}%
}
