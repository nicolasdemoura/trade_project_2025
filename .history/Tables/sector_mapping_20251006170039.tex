\begin{table}[H]
\centering
\caption{Sector Mapping: Model Sectors to WIOD and HS Classifications}
\label{tab:sector_mapping}
\footnotesize
\renewcommand{\arraystretch}{1.2}
\resizebox{\textwidth}{!}{%
\begin{tabular}{>{\raggedright}p{2.5cm} >{\raggedright}p{4cm} >{\raggedright\arraybackslash}p{8cm}}
\toprule
...
& \multirow{3}{4cm}{Rubber and Plastics (25, c10)} & 31: Fertilizers; 32: Tanning/dyeing extracts; 33: Essential oils/perfumery; \\
...
\midrule
\multirow{2}{2.5cm}{\textbf{Construction}} & Construction (F, c18) & \multirow{2}{8cm}{25: Salt/sulphur/earths and stone; 68: Articles of stone/plaster/cement} \\
& Real Estate Activities (70, c29) & \\
\midrule
\multirow{2}{2.5cm}{\textbf{Energy}} & Coke, Refined Petroleum and Nuclear Fuel (23, c8) & \multirow{2}{8cm}{27: Mineral fuels/oils; 84: Nuclear reactors/boilers/machinery} \\
& Electricity, Gas and Water Supply (E, c17) & \\
\midrule
\multirow{2}{2.5cm}{\textbf{Food}} & Agriculture, Hunting, Forestry and Fishing (AtB, c1) & 1: Live animals; 2: Meat; 3: Fish/crustaceans; 4: Dairy produce; \\
...
\midrule
\multirow{4}{2.5cm}{\textbf{Manufacture}} & Electrical and Optical Equipment (30t33, c14) & 37: Photographic goods; 40: Rubber articles; 41: Raw hides/skins; \\
...
\midrule
\multirow{2}{2.5cm}{\textbf{Paper}} & Pulp, Paper, Printing and Publishing (21t22, c7) & \multirow{2}{8cm}{44: Wood/wood articles; 47: Wood pulp; 48: Paper/paperboard} \\
& Wood and Products of Wood and Cork (20, c6) & \\
\midrule
\multirow{3}{2.5cm}{\textbf{Retail and Wholesale}} & Retail Trade, Except Motor Vehicles (52, c21) & \multirow{3}{8cm}{\textit{Non-tradable services sector}} \\
& Sale/Maintenance of Motor Vehicles (50, c19) & \\
& Wholesale Trade and Commission Trade (51, c20) & \\
\midrule
\multirow{7}{2.5cm}{\textbf{Services}} & Education (M, c32); Financial Intermediation (J, c28) & \multirow{7}{8cm}{\textit{Non-tradable services sector}} \\
...
\midrule
\multirow{2}{2.5cm}{\textbf{Textiles}} & Leather, Leather and Footwear (19, c5) & 50: Silk; 51: Wool/animal hair; 52: Cotton; 53: Other vegetable fibers; \\
...
\midrule
\multirow{3}{2.5cm}{\textbf{Transport}} & Air Transport (62, c25) & \multirow{3}{8cm}{\textit{Non-tradable services sector}} \\
