...
& United Kingdom & GBR \\
\midrule
\multirow{1}{3cm}[0pt]{\textbf{European Union}} & Austria, Belgium, Bulgaria, Croatia, Cyprus, Czech Republic, Denmark, Estonia, Finland, France, Germany, Greece, Hungary, Ireland, Italy, Latvia, Lithuania, Luxembourg, Malta, Netherlands, Poland, Portugal, Romania, Slovakia, Slovenia, Spain, Sweden & AUT, BEL, BGR, HRV, CYP, CZE, DNK, EST, FIN, FRA, DEU, GRC, HUN, IRL, ITA, LVA, LTU, LUX, MLT, NLD, POL, PRT, ROU, SVK, SVN, ESP, SWE \\
\midrule
\multirow{1}{3cm}[0pt]{\textbf{Rest of World}} & Australia, Indonesia, Korea, Russia, Turkey, Taiwan, Other economies & AUS, IDN, KOR, RUS, TUR, TWN, RoW \\
\bottomrule
\end{tabular}%
}
\begin{tablenotes}
